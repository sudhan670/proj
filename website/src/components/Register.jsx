       ...
       <div className="container shadow my-5">
                <div className="row justify-content-end">
                    <div className="col-md-5 d-flex flex-column align-items-center text-white form order-2">
                     ...
                     <a href={"../login"} className="btn btn-outline-light rounded-pill
                     w-50">Login</a>
                    </div>
                        ...
                        <h1 className="display-6 fw-bolder text-center mb-4 ">Register</h1>
                            <form>
                                <div class="mb-3 col-sm-10">
                                    <label for="exampleFormControlInput1" class="form-label"><h5>User Name</h5></label>
                                    <input type="email" class="form-control" id="username" placeholder="yourname" />
                                </div>
                                <div class="mb-3 col-sm-10">
                                ...
                                <div class="md-3">
                                    <label for="inputPassword" class="col-sm-2 col-form-label"><h5>Password</h5></label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" id="inputPassword" />
                                    </div>
                                    <label for="inputPassword" class="col-sm-2 col-form-label"><h5>ConfirmPassword</h5></label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" id="inputPassword" />
                                    </div>
                                    <div class="col-12 text-center pt-5">
                                        <button class="btn btn-primary w-50 text-center" type="submit">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
